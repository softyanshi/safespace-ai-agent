...
def find_nearby_therapists_by_location(location: str) -> str:
    """
    Finds and returns a list of mental health support centers near the specified location.
    """
    from tools import find_support_nearby
    return find_support_nearby(location)
